 ...
 * updates.
 */
export declare const enum MainMessageType {
  Initialization = "init",
  LoadContent = "load",
  StopContent = "stop",
 ...
 */
export declare const enum InitializationErrorCode {
  /**
   * The corresponding worker received a `InitializationMainMessage` despite
   * already being initialized.
   */
  AlreadyInitializedError = 0,
  /**
...
export declare enum SourceBufferCreationErrorCode {
  /**
